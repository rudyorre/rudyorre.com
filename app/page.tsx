            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Rudy
                  <br />
                  <span className="text-muted-foreground">Orre</span>
                </h1>
              </div>
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            ...
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                {
                  title: "Chronicle Detection Framework",
                  description:
                    "Built scalable detection infrastructure processing billions of security events daily across enterprise environments.",
                  tech: ["Python", "YARA-L", "BigQuery"],
                  year: "2024",
                },
                {
                  title: "Chorus Communication Platform",
                  description:
                    "Developed experimental communication tools at Google X exploring new paradigms for team collaboration.",
                ...
                },
                {
                  ...
                  description:
                    "Designed automated threat intelligence ingestion and correlation system for security operations.",
                ...
                },
                {
                  ...
                  description:
                    "Created real-time security analytics visualization platform for SOC analysts and incident responders.",
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <svg
                        className="w-5 h-5 text-muted-foreground group-hover:text-foreground transition-all duration-300 transform group-hover:translate-x-1 group-hover:-translate-y-1"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              ...
              <div className="text-sm text-muted-foreground font-mono">2020 — 2024</div>
            </div>
