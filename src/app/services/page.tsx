            ...
            <section className="">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-primary">Professional Services</h2>
                        <p className="text-foreground/50 sm:text-xl">I'm available for the following professional services. These include short-term and long-term contract software development contracting.</p>
                        <p>Schedule or get a quote: <Link href="/#Contact">Contact Rudy</Link></p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold">Full-Stack Web Development</h3>
                            <p className="text-gray-500">I can build modern, user-friendly web applications, ideally in NextJS/Tailwind/Typescript however I'm experienced in other stacks.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold">Data Science Consulting</h3>
                            <p className="text-gray-500">I can analyze data, develop models, and generate insights to solve complex problems. This includes NLP, LLMs, and computer vision.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold">Transfer Advising</h3>
                            <p className="text-gray-500">I guide students through the community college transfer process for seamless success.</p>
                        </div>
                    </div>
                </div>
            </section>
