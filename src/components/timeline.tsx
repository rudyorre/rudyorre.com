                    ...
                    <li key={"jobs" + i} className="ms-6 mb-5">            
                        <Accordion key={job.role + job.company} type="single" collapsible>
                            <AccordionItem value="item-1">
                                ...
                                <h3 className="flex items-center mb-1 text-lg font-semibold">{job.role} <span className="hidden sm:block bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">{job.company}</span></h3>
