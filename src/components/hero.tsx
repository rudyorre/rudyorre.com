      ...
      <div className="col-auto m-auto">
        ...
        <div className="flex gap-4 mt-4">
          <Link href="https://github.com/rudyorre" target="_blank">
            <FontAwesomeIcon icon={faGithub} className={`fa-3x text-secondary-foreground/50 hover:text-primary cursor-pointer
              "transform transition-all duration-300 ease-in-out hover:translate-x-1`
              }
            />
          </Link>
          <Link href="https://linkedin.com/in/rudyorre" target="_blank">
            <FontAwesomeIcon icon={faLinkedin} className={`fa-3x text-secondary-foreground/50 hover:text-primary cursor-pointer
              "transform transition-all duration-300 ease-in-out hover:translate-x-1`
              }
            />
          </Link>
          <Link href="https:/instagram.com/rudyorre" target="_blank">
            <FontAwesomeIcon icon={faInstagram} className={`fa-3x text-secondary-foreground/50 hover:text-primary cursor-pointer
              "transform transition-all duration-300 ease-in-out hover:translate-x-1`
              }
            />
          </Link>
